  ...
  function constructor(containerElOrString, config) {
    ...
    function stopDraggedPiece(location) {
      ...
      if (isFunction(config.onDrop)) {
        ...
        // If we're expecting a callback, don't trigger it before the update
      ...
      // If we have a move callback, trigger onDrop after the action is done
      if (isFunction(config.onDrop) && config.moveCallback) {
        config.onDrop(
          widget.move,
          draggedPieceSource,
          location,
